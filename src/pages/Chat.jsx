      ...
      <form onSubmit={handleSubmit} className="chat-form">
        ...
        <button type="submit" className="form-icon send-button">
          {newMessage.trim() ? (
            ...
            // Icono de micrófono
            <svg classname="microphone-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16" onClick={handleFeatureInDevelopment}>
