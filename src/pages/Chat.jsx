  ...
  return (
    <div className="chat-container">
        ...
        <div className="chat-icons">
          <div className="video-dropdown-group">
            ...
            <button className="icon-btn video-call-icon">
              <svg className="camera-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <button className="icon-btn chevron-icon">
              <svg className="chevron-icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" viewBox="0 0 16 16">
              ...
              <div className="message-meta">
                ...
                {msg.from === "me" && (
                  <span className="message-tick">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" strokeWidth={3} viewBox="0 0 16 16">
      ...
      <form onSubmit={handleSubmit} className="chat-form">
        {/* Icono "+" */}
        <button type="button" className="form-icon plus-icon">
        ...
        {/* Icono emoji */}
        <button type="button" className="form-icon emoji-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
        ...
        <button type="submit" className="form-icon send-button">
          {newMessage.trim() ? (
            ...
            <svg className= "send-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
              <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
            </svg>
          ) : (
            // Icono de micrófono
            <svg classname="microphone-icon" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
